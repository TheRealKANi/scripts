...
arch-chroot /mnt /bin/bash -e <<EOF
  ...
  # Set working sound card profile
  #pactl set-card-profile alsa_card.pci.0000_00_1f.3-platform-tgl_rt1011_rt5682 pro-audio

  # Set default output sink
  #pactl set-default-sink alsa_output.pci-0000_00_1f.3-platform-tgl_rt1011_rt5682.pro-output-0

  # Mute all input skinks
  #pactl list short sources | awk '/input.*RUNNING|SUSPENDED/ {system("pactl set-source-mute " $1 " true")}'

  # Mute all output sinks
